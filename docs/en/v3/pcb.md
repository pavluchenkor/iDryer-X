...
!!! note "Download Files for r2.1"

```
PCB Design r2.1 on [jlcpcb.com](https://oshwlab.com/svet_team/idryer_copy_copy)

BOM for DIY assembly r2.1 on [Google Docs](https://docs.google.com/spreadsheets/d/1Y0MG9n_SadcK8cb_-e9J9ABQYqM_iH7iXZHlKbaz7wk/edit?usp=sharing)
```
